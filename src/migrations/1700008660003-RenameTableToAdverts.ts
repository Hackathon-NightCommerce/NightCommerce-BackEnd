...
export class RenameTableToAdverts1700008660003 implements MigrationInterface {
    name = 'RenameTableToAdverts1700008660003'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "items_cart" ("id" SERIAL NOT NULL, "qtd" integer NOT NULL, "price" integer NOT NULL, "user_id" integer, "advert_id" integer, CONSTRAINT "PK_e18e87dca227ffef10b99c8dae3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "adverts" ("id" SERIAL NOT NULL, "name" character varying(250) NOT NULL, "brand" text NOT NULL, "price" integer NOT NULL, "description" text NOT NULL, "cover_image" text NOT NULL, "information_additional" character varying(250), "category" text NOT NULL, "published" boolean, "qtd" integer NOT NULL, "promotion" boolean, "userId" integer, CONSTRAINT "PK_36876931b51109a932d0bf3b40a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "items_cart" ADD CONSTRAINT "FK_f5af918beb54f194d6e7c5e1341" FOREIGN KEY ("advert_id") REFERENCES "adverts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "items_cart" DROP CONSTRAINT "FK_f5af918beb54f194d6e7c5e1341"`);
